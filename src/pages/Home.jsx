...
const Home = () => {
  return (
    <>
      <div className="w-full flex justify-center bg-[url('../public/assets/images/home/homeback.png')] sm:bg-cover sm:bg-no-repeat bg-center scrollbar-hide">
        <div className="relative box-border mx-auto my-10 border-solid border-2 border-black rounded-t-2xl">
          ...
          <img
            ...
            className="block absolute object-contain top-[50%] -left-[35%] z-[2]"
            alt=""
          />
          <img
            src="/assets/images/home/2.png"
            className="block absolute object-contain top-[10%] -right-[30%] z-[2]"
            alt=""
          />
          {/* Floating images end */}
          ...
          {/* GFG Body start */}
          <div className="h-screen scrollbar scrollbar-thumb-[#D9D9D9] overflow-y-scroll scrollbar-thumb-rounded-lg scrollbar-track-rounded-full">
